...
- [/soneta-tools](../../soneta-tools/SKILL.md) — operacje na bazach z wiersza poleceń: kopia
...
- [/soneta-programming](../../soneta-programming/SKILL.md) — rekordy guidowane i paczki danych,
