...
| ResolutionTimeUnit | `Soneta.Core.ServiceDesk.SLATimeUnit` (enum) | bazodanowe | Jednostka czasu naprawy | Jednostka czasu naprawy |
| ResponseTime | `double` | bazodanowe | Czas reakcji | Czas reakcji |
| ResponseTimeUnit | `Soneta.Core.ServiceDesk.SLATimeUnit` (enum) | bazodanowe | Jednostka czasu reakcji | Jednostka czasu reakcji |
