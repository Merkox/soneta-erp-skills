# Pola i właściwości klasy biznesowej: `Soneta.SrodkiTrwale.TytulDokumentuST`
Nazwa tabeli: `TytulyDokST`
Tytuł: Tytuły dokumentów
Opis: Słownik tytułów dokumentów środków trwałych (np. OT, LT, MT). Definiuje typy i symbole dokumentów ewidencyjnych oraz ich kategorię na potrzeby sprawozdania F-03. Stanowi podstawę konfiguracji obiegu dokumentów w module środków trwałych.
