# Pola i właściwości klasy biznesowej: `Soneta.Kasa.PreliminarzDokument`
Nazwa tabeli: `PreliminarzDok`
Tytuł: Dokumenty preliminarza
Opis: Dokument preliminarza płatności służący do planowania przyszłych przepływów pieniężnych. Grupuje pozycje preliminarza z planowanymi wpłatami i wypłatami, umożliwiając prognozowanie sald na rachunkach bankowych i w kasach.
