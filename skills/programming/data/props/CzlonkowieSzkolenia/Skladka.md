# Pola i właściwości klasy biznesowej: `Soneta.CzlonkowieSzkolenia.Skladka`
Nazwa tabeli: `Skladki`
Tytuł: Składki
Opis: Dokumenty naliczonych składek członkowskich za poszczególne okresy. Przechowują naliczenia opłat dla członków z wartością, stanem rozliczenia i danymi księgowymi, stanowiąc podstawę generowania płatności.
...
### StanSkładki (`Soneta.CzlonkowieSzkolenia.StanSkładki`)
- `Bufor` = 0 — Bufor
- `Anulowany` = 1
- `Zatwierdzony` = 2
- `Razem` = 666
