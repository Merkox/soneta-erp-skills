# Pola i właściwości klasy biznesowej: `Soneta.Ksiega.ZleDlugiDokument`
Nazwa tabeli: `ZDDokumenty`
Tytuł: Dokumenty ZD
Opis: Dokument rozliczenia złych długów (ZD) służy do ewidencji korekt podatku dochodowego wynikających z nieuregulowanych należności lub zobowiązań. Zawiera datę dokumentu, definicję, numer, graniczną datę zapłat oraz status buforowy, zgodnie z przepisami o uldze na złe długi.
