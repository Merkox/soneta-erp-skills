...
| From | `UI.Diagram.IConnectableNode` |  |  |  |
| FromPoint | `System.Drawing.PointF` |  |  |  |
| Host | `IWorkflowItemDescriptionHost` | bazodanowe, iface-ref | Element powiązany | Element powiązany z komentarzem |
| Identifier | `System.Guid` | bazodanowe, tylko-odczyt | Identyfikator wiersza | Określa identyfikator wiersza |
| LinePoints | `System.Drawing.PointF[]` | podlista |  |  |
| Location | `System.Drawing.PointF` |  |  |  |
| SourceNodePort | `int` |  |  |  |
| TargetNodePort | `int` |  |  |  |
| To | `UI.Diagram.IConnectableNode` |  |  |  |
