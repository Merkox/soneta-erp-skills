# Pola i właściwości klasy biznesowej: `Soneta.CRM.DokumentZdarzenia`
Nazwa tabeli: `DokumentyZdarzen`
Tytuł: Zdarzenia
Opis: Dokument zdarzenia CRM rejestrujący interakcję z kontrahentami (spotkania, rozmowy, oferty). Zawiera daty planowane i realizacji, przypisanego operatora, osobę kontaktową oraz temat, stanowiąc podstawę historii kontaktów.
