...
| Netto | `DoubleCy` | bazodanowe | Cena promocyjna netto | Promocyjna cena netto. |
...
| Rabat | `Percent` | bazodanowe | Rabat promocyjny | Procent rabatu promocyjnego. |
| Rabatowana | `bool` | bazodanowe |  | Wskazuje na to, czy promocja podlega rabatowaniu. |
| StandardowaIlosc | `Soneta.Towary.Quantity` | tylko-odczyt |  |  |
