...
Lista interfejsów i tabel je implementujących:
...
| BICode | Algorytmy BI | `BICodes` | konfig | root |  |  | BICodeType (1) | [BI/BICode.md](BI/BICode.md) |
...
| DashboardItemDefinition | Definicje elementów wizualizacji | `DashBrdItemDefs` | konfig | root |  |  | DashboardItemType (3) | [BI/DashboardItemDefinition.md](BI/DashboardItemDefinition.md) |
...
| DataModel | Modele danych | `DataModels` | konfig | root |  | IRightsSource, IAreaHost | DataModelType (7) | [BI/DataModel.md](BI/DataModel.md) |
...
| DataSource | Źródła danych | `DataSources` | konfig | root |  |  | DataSourceType (3) | [BI/DataSource.md](BI/DataSource.md) |
...
| DataSpanItemDefinition | Definicje elementów przedziałów danych | `DataSpanItemDefs` | konfig | child: DataSpanSet→DataSpanSetDefinition |  |  | FieldType (5) | [BI/DataSpanItemDefinition.md](BI/DataSpanItemDefinition.md) |
| DataSpanSetDefinition | Zestawy przedziałów danych | `DataSpanSetDefs` | konfig | root |  |  | FieldType (5) | [BI/DataSpanSetDefinition.md](BI/DataSpanSetDefinition.md) |
...
| TimeSpanDefinition | Definicje przedziałów czasowych | `TimeSpanDefs` | konfig | root |  |  | TimeSpanType (2) | [BI/TimeSpanDefinition.md](BI/TimeSpanDefinition.md) |
...
| DashboardView | Panele | `DashbrdViews` | konfig | root |  | IRightsSource | DashboardViewType (5) | [Business/DashboardView.md](Business/DashboardView.md) |
...
| ExternalDatabase | Zewnętrzne bazy danych | `ExtDatabases` | konfig | root |  | IRightsSource | ExternalDatabaseArea (1) | [Business/ExternalDatabase.md](Business/ExternalDatabase.md) |
...
| PivotView | Raporty przestawne | `PivotViews` | konfig | root |  | IRightsSource | PivotViewType (2) | [Business/PivotView.md](Business/PivotView.md) |
...
| RuntimeFieldDefinition | Definicje pól dynamicznych | `RuntimeFieldDefs` | konfig | root |  |  | RuntimeRowType (1) | [Business/RuntimeFieldDefinition.md](Business/RuntimeFieldDefinition.md) |
...
| SysNotification | Powiadomienia | `SysNotifications` | konfig | root |  | IWfPlugInItemReferenceHost, IWFRecipientHost | DefinitionTypeEnum (3) | [Business/SysNotification.md](Business/SysNotification.md) |
...
| SystemFile | Systemowe pliki dodatkowe | `SystemFiles` | konfig | root |  |  | SystemFileTypes (2) | [Business/SystemFile.md](Business/SystemFile.md) |
...
| AuthProvider | Dostawcy autoryzacji | `AuthProviders` | konfig | root |  |  | AuthProviderType (3) | [CRM/AuthProvider.md](CRM/AuthProvider.md) |
...
| KontoPocztowe | Konta pocztowe | `KontaPocztowe` |  | root |  | IRightsSource | AuthProviderType (3) | [CRM/KontoPocztowe.md](CRM/KontoPocztowe.md) |
...
| Region | Regiony sprzedażowe | `Regiony` | konfig | root |  | IRightsSource | RegionTypeEnum (7) | [CRM/Region.md](CRM/Region.md) |
...
| WiadomoscEmail | Wiadomości email | `WiadomosciEmail` |  | root |  | IPermissionClient | TypWiadomości (4) | [CRM/WiadomoscEmail.md](CRM/WiadomoscEmail.md) |
...
| ZUS | Urzędy | `ZUSY` |  | root |  | IPodmiot, IPodmiotKasowy, IAdresHost, IElementSlownika | TypUrzędu (4) | [CRM/ZUS.md](CRM/ZUS.md) |
...
| DbTupleDefinition | Definicje dokumentów dodatkowych | `TuplesDefs` | konfig | root |  | IRuntimeRowDefinition, IRightsSource, IManagedRowDefinion, IWizardReferenceHost, ICodeFileHost, ISysNotificationHost, IWfPlugInReferenceHost, IPreviewPageHost | DbTupleDefinitionType (2) | [Core/DbTupleDefinition.md](Core/DbTupleDefinition.md) |
...
| DefXmlNag | Definicje XML | `DefsXmlNag` | konfig | root |  |  | SelektorDefXml (15) | [Core/DefXmlNag.md](Core/DefXmlNag.md) |
| DefinicjaDokumentu | Definicje dokumentów | `DefDokumentow` | konfig | root |  | IRightsSource, IDefinicjaKomunikatuEDIHost, IDefinicjaDokumentuOA | TypDokumentu (179) | [Core/DefinicjaDokumentu.md](Core/DefinicjaDokumentu.md) |
...
| DiscussionPlugInRef | Powiązania rozszerzeń | `DiscPlugInRefs` |  | child: Definition→IDiscussionPlugInHost |  |  | DiscussionPlugInRefType (2) | [Core/DiscussionPlugInRef.md](Core/DiscussionPlugInRef.md) |
...
| DiscussionUser | Użytkownicy dyskusji | `DiscussionUsers` |  | root |  |  | PersonKind (3) | [Core/DiscussionUser.md](Core/DiscussionUser.md) |
...
| DokEwidencji | Dokument ewidencji | `DokEwidencja` |  | root |  | IDokumentPlatny, IDaneKontrahentaHost, IRaportEwidencjiSP, IDokumentCRM, IKomunikatEDIHost, IEmailElement, IProceduraVATHost, IDigitalizedDocument | TypDokumentu (29) | [Core/DokEwidencji.md](Core/DokEwidencji.md) |
...
| GIODOPrzetwarzanie | Czynności przetwarzania | `GIODOPrzetwarz` |  | root |  |  | SelektorPrzetwarzania (2) | [Core/GIODOPrzetwarzanie.md](Core/GIODOPrzetwarzanie.md) |
...
| GIODOWymianaDanych |  | `GIODOWymDanych` |  | root |  |  | GIODOKierunekWymianyDanych (5) | [Core/GIODOWymianaDanych.md](Core/GIODOWymianaDanych.md) |
...
| HistoriaDanychFirmyBase | Historia danych firmy | `HstDanychFirmy` | konfig | root |  |  | RodzajHistoriiFirmy (2) | [Core/HistoriaDanychFirmyBase.md](Core/HistoriaDanychFirmyBase.md) |
...
| PozycjaEwidencjiZbiorczej | Pozycje ewidencji zbiorczych | `PozEwidZbiorczej` |  | child: Ewidencja→DokEwidencji |  |  | TypDokumentu (1) | [Core/PozycjaEwidencjiZbiorczej.md](Core/PozycjaEwidencjiZbiorczej.md) |
...
| ProceduraVAT | Słownik procedur VAT | `ProceduryVAT` | konfig | root |  |  | TypProceduryVAT (5) | [Core/ProceduraVAT.md](Core/ProceduraVAT.md) |
...
| SlownikElem | Słownik | `Slowniki` | konfig | root |  |  | SelektorSlownika (1) | [Core/SlownikElem.md](Core/SlownikElem.md) |
...
| SystemZewn | Lista systemów zewnętrznych | `SystemyZewn` | konfig | root |  |  | TypSystemuZewn (11) | [Core/SystemZewn.md](Core/SystemZewn.md) |
...
| RodzajSzkol | Rodzaje szkoleń | `RodzajeSzkol` |  | root |  | IElementSlownika | RodzajSzkolenia (2) | [CzlonkowieSzkolenia/RodzajSzkol.md](CzlonkowieSzkolenia/RodzajSzkol.md) |
...
| UczestnikBase | Uczestnicy, członkowie | `Uczestnicy` |  | root |  | IPeselHost, INipHost, IPlecHost, IGIODOZgodnyHost, IGIODOWymianaDanychHost, IGIODOOświadczenieHost, IEmailElement, IOceniany | TypUczestnika (3) | [CzlonkowieSzkolenia/UczestnikBase.md](CzlonkowieSzkolenia/UczestnikBase.md) |
...
| ZajecieSzkolBase | Zajęcia | `ZajeciaSzkol` |  | root |  | IŹródłoOceny | TypZajeciaSzkol (4) | [CzlonkowieSzkolenia/ZajecieSzkolBase.md](CzlonkowieSzkolenia/ZajecieSzkolBase.md) |
...
| RowType | Tytuł | Tabela | Konfig | Guided | Historia | Interfaces | Selektor | Plik |
|---------|-------|--------|--------|--------|----------|------------|----------|------|
| Deklaracja |  | `Deklaracje` |  | root |  | IDeklaracja, IDokumentPlatny, IDokumentKsiegowalny, IBazaZrodlaWyplaty, IEmailElement, IZrodloOpisuAnalitycznego | WersjaDeklaracji (429) | [Deklaracje/Deklaracja.md](Deklaracje/Deklaracja.md) |
...
| RowType | Tytuł | Tabela | Konfig | Guided | Historia | Interfaces | Selektor | Plik |
|---------|-------|--------|--------|--------|----------|------------|----------|------|
| DefinicjaPowstaniaObowiazkuVAT | Definicje powstania obowiązku VAT | `DefinicjePOVAT` | konfig | root |  |  | TypTytułuObowiązkuVAT (4) | [EwidencjaVat/DefinicjaPowstaniaObowiazkuVAT.md](EwidencjaVat/DefinicjaPowstaniaObowiazkuVAT.md) |
| ElemEwidencjiVATAkcyzy | Elementy ewidencji VAT | `EleEwidencjiVATT` |  | child: Naglowek→NagEwidencjiVATAkcyzy |  | IZrodloOpisuAnalitycznego | TypEwidencjiVAT (4) | [EwidencjaVat/ElemEwidencjiVATAkcyzy.md](EwidencjaVat/ElemEwidencjiVATAkcyzy.md) |
| ElemRozliczeniaVATAkcyzy | Elementy rozliczen VAT | `EleRozliczenVATT` |  | child: Naglowek→NagRozliczeniaVATAkcyzy |  |  | TypEwidencjiVAT (4) | [EwidencjaVat/ElemRozliczeniaVATAkcyzy.md](EwidencjaVat/ElemRozliczeniaVATAkcyzy.md) |
| NagEwidencjiVATAkcyzy | Nagłóweki ewidencji VAT | `NagEwidencjiVATT` |  | child: Ewidencja→DokEwidencji |  |  | TypEwidencjiVAT (4) | [EwidencjaVat/NagEwidencjiVATAkcyzy.md](EwidencjaVat/NagEwidencjiVATAkcyzy.md) |
| NagRozliczeniaVATAkcyzy | Nagłówki rozliczeń VAT | `NagRozliczenVATT` |  | child: Naglowek→NagEwidencjiVATAkcyzy |  |  | TypRozliczeniaVAT (4) | [EwidencjaVat/NagRozliczeniaVATAkcyzy.md](EwidencjaVat/NagRozliczeniaVATAkcyzy.md) |
...
| KwalifikacjePracownikaZkl | Kwalifikacje pracownika | `ZKLKwalPrac` |  | child: Pracownik→Pracownik |  |  | TypKwalifikacjiPracownika (3) | [HR/KwalifikacjePracownikaZkl.md](HR/KwalifikacjePracownikaZkl.md) |
...
| OfertaSzkolenia | Oferty szkoleń | `OfertySzkolen` |  | root |  | IAdresHost | TypOfertySzkolenia (2) | [HR/OfertaSzkolenia.md](HR/OfertaSzkolenia.md) |
...
| PowiazanieDefStanSlownikiZkl | Powiązania stanowisk z pozycjami słowników ZKL | `PowDefStZklSlw` | konfig | root |  |  | TypPowiazaniaSlownikaZkl (5) | [HR/PowiazanieDefStanSlownikiZkl.md](HR/PowiazanieDefStanSlownikiZkl.md) |
| PowiazanieDefinicjiStanowisk | Powiązania definicji stanowisk | `PowDefStan` | konfig | root |  |  | TypPowiazaniaStanowisk (3) | [HR/PowiazanieDefinicjiStanowisk.md](HR/PowiazanieDefinicjiStanowisk.md) |
...
| PozycjaJezykowObcychProfilu | Pozycje języków obcych profilu | `ZklPozKwalJezyki` | konfig | root |  |  | RodzajWymagania (2) | [HR/PozycjaJezykowObcychProfilu.md](HR/PozycjaJezykowObcychProfilu.md) |
...
| PozycjaKwalifikacjiZawodowychProfilu | Pozycje kwalifikacji zawodowych profilu | `ZklPozKwalKwal` | konfig | root |  |  | RodzajWymagania (2) | [HR/PozycjaKwalifikacjiZawodowychProfilu.md](HR/PozycjaKwalifikacjiZawodowychProfilu.md) |
| PozycjaMaszynIUrzadzenProfilu | Pozycje maszyn i urządzeń profilu | `ZklPozKwalMaszyn` | konfig | root |  |  | RodzajWymagania (2) | [HR/PozycjaMaszynIUrzadzenProfilu.md](HR/PozycjaMaszynIUrzadzenProfilu.md) |
...
| PozycjaProfiluKompetencjiMerytorycznych | Pozycje profilu kompetencji merytorycznych | `ZklPozProfilKKM` | konfig | root |  |  | RodzajWymagania (2) | [HR/PozycjaProfiluKompetencjiMerytorycznych.md](HR/PozycjaProfiluKompetencjiMerytorycznych.md) |
| PozycjaProfiluKompetencjiUniwersalnych | Pozycje profilu kompetencji uniwersalnych | `ZklPozProfilKKU` | konfig | root |  |  | RodzajWymagania (2) | [HR/PozycjaProfiluKompetencjiUniwersalnych.md](HR/PozycjaProfiluKompetencjiUniwersalnych.md) |
...
| PozycjaSystemowITProfilu | Pozycje systemów IT profilu | `ZklPozKwalIT` | konfig | root |  |  | RodzajWymagania (2) | [HR/PozycjaSystemowITProfilu.md](HR/PozycjaSystemowITProfilu.md) |
...
| PozycjaWyksztalceniaProfilu | Pozycje wykształcenia profilu | `ZklPozKwalWykszt` | konfig | root |  |  | WyksztalcenieProfiluSelektor (6) | [HR/PozycjaWyksztalceniaProfilu.md](HR/PozycjaWyksztalceniaProfilu.md) |
...
| KartaOpisuStanowiskaBase | Karty opisu stanowisk | `KartyOpStanowisk` |  | root |  |  | TypyKartOpisuStanowiska (2) | [HR2/KartaOpisuStanowiskaBase.md](HR2/KartaOpisuStanowiskaBase.md) |
...
| DefRelacjiHandlowej | Definicje relacji handlowych | `DefRelHandlowych` | konfig | root |  |  | TypRelacjiHandlowej (12) | [Handel/DefRelacjiHandlowej.md](Handel/DefRelacjiHandlowej.md) |
...
| LimitWartosci | Limity wartości dokumentu. | `LimityWartosci` |  | child: Definicja→DefDokHandlowego |  |  | LimitWartosciTyp (3) | [Handel/LimitWartosci.md](Handel/LimitWartosci.md) |
...
| RelacjaHandlowa |  | `RelacjeHandlowe` |  | root |  |  | TypRelacjiHandlowej (17) | [Handel/RelacjaHandlowa.md](Handel/RelacjaHandlowa.md) |
...
| RowType | Tytuł | Tabela | Konfig | Guided | Historia | Interfaces | Selektor | Plik |
|---------|-------|--------|--------|--------|----------|------------|----------|------|
| Akord |  | `Akordy` |  | root | historyczna → AkordHistoria | IBazaZrodlaWyplaty | TypAkordu (2) | [Kadry/Akord.md](Kadry/Akord.md) |
| AkordHistoria | Historia akordu | `AkordHistorie` |  | child: Akord→Akord | historia → Akord | IAkord | TypAkordu (2) | [Kadry/AkordHistoria.md](Kadry/AkordHistoria.md) |
...
| DefinicjaAkordu | Definicje akordów | `DefinicjeAkordow` | konfig | root |  | IAkord | TypAkordu (2) | [Kadry/DefinicjaAkordu.md](Kadry/DefinicjaAkordu.md) |
...
| DefinicjaNagrodyKary | Definicje nagród lub kar | `DefNagrodKar` | konfig | root |  |  | TypNagrodyKary (2) | [Kadry/DefinicjaNagrodyKary.md](Kadry/DefinicjaNagrodyKary.md) |
...
| HistoriaZatrudnieniaBase | Historia zatrudnienia | `HistZatrudnien` |  | root |  | IManagedRowInfoHost | TypHistoriiZatrudnienia (2) | [Kadry/HistoriaZatrudnieniaBase.md](Kadry/HistoriaZatrudnieniaBase.md) |
...
| KorektaZajęciaKomorniczego | Korekty zajęć komorniczych | `KorektyZajKomor` |  | root |  | IBazaZrodlaWyplaty | RodzajeKorektZajęćKomorniczych (3) | [Kadry/KorektaZajęciaKomorniczego.md](Kadry/KorektaZajęciaKomorniczego.md) |
...
| NagrodaKara |  | `NagrodyKary` |  | root |  | IBazaZrodlaWyplaty, IPowiązanieWypłaty | TypNagrodyKary (2) | [Kadry/NagrodaKara.md](Kadry/NagrodaKara.md) |
...
| UmowaZewnetrzna | Umowy zewnętrzne | `UmowyZewnetrzne` |  | root | historyczna → UmowaZewnetrznaHistoria | IZrodloPodzielnikaKosztow, IUmowaZKalendarzem, IZrodloPlanu, IDostepnoscHost, IZrodloNieobecnosci, IZrodloWnioskuONieobecnosc | TypUmowyZewnetrznej (2) | [Kadry/UmowaZewnetrzna.md](Kadry/UmowaZewnetrzna.md) |
| UmowaZewnetrznaHistoria | UmowyZewnetrzne | `UmowyZewnHist` |  | child: Umowa→UmowaZewnetrzna | historia → UmowaZewnetrzna |  | TypUmowyZewnetrznej (2) | [Kadry/UmowaZewnetrznaHistoria.md](Kadry/UmowaZewnetrznaHistoria.md) |
...
| ZmianaWkładuFunduszuPozyczkowego | Zmiany wkładów do funduszy pożyczkowych | `ZmianaWklFundPoz` |  | root |  | IBazaZrodlaWyplaty | KierunekZmianyWkładuFunduszuPożyczkowego (2) | [Kadry/ZmianaWkładuFunduszuPozyczkowego.md](Kadry/ZmianaWkładuFunduszuPozyczkowego.md) |
...
| DefinicjaAktualizacjiKalendarza | Definicje dokumentów aktualizacji kalendarzy | `DefAktKalendarzy` | konfig | root |  | IRightsSource | RodzajAktualizacjiKalendarza (2) | [Kalend/DefinicjaAktualizacjiKalendarza.md](Kalend/DefinicjaAktualizacjiKalendarza.md) |
...
| DefinicjaWeryfikatoraKalendarza | Definicje weryfikatorów dla kalendarzy | `DefWeryfKalend` | konfig | root |  |  | RodzajWeryfikacjiKalendarza (11) | [Kalend/DefinicjaWeryfikatoraKalendarza.md](Kalend/DefinicjaWeryfikatoraKalendarza.md) |
...
| DokumentAktualizacjiKalendarza | Dokumenty aktualizacji kalendarzy | `DokAktKalendarzy` |  | root |  | IŹródłoPowiązaniaStrukturyOrganizacyjnej, IDokumentAktualizacjiKalendarza, IDokument | RodzajAktualizacjiKalendarza (2) | [Kalend/DokumentAktualizacjiKalendarza.md](Kalend/DokumentAktualizacjiKalendarza.md) |
| DzienAkorduBase | Dni akordów | `DniAkordow` |  | child: Akord→Akord |  |  | TypAkordu (2) | [Kalend/DzienAkorduBase.md](Kalend/DzienAkorduBase.md) |
| DzienKalendarzaAktualizacja |  | `DniKalendAkt` |  | child: Pozycja→PozycjaAktualizacjiKalendarza |  |  | TypKalendarza (2) | [Kalend/DzienKalendarzaAktualizacja.md](Kalend/DzienKalendarzaAktualizacja.md) |
| DzienKalendarzaBase |  | `DniKalendarza` |  | child: Kalendarz→KalendarzBase |  |  | TypKalendarza (6) | [Kalend/DzienKalendarzaBase.md](Kalend/DzienKalendarzaBase.md) |
...
| KalendarzBase |  | `Kalendarze` |  | root |  |  | TypKalendarza (6) | [Kalend/KalendarzBase.md](Kalend/KalendarzBase.md) |
...
| LimitNieobecnosci | Limity nieobecności | `LimNieobecnosci` |  | child: Pracownik→Pracownik |  |  | TypLimituNieobecności (2) | [Kalend/LimitNieobecnosci.md](Kalend/LimitNieobecnosci.md) |
| Nieobecnosc | Nieobecności | `Nieobecnosci` |  | root |  | IZrodloNieobecnosci, IBazaZrodlaWyplaty, IBilansOtwarcia, IZrodloDeklaracji | TypŹródłaNieobecności (4) | [Kalend/Nieobecnosc.md](Kalend/Nieobecnosc.md) |
...
| ZestawienieAkorduBase | Zestawienia akordów | `ZestawAkordow` |  | child: Akord→Akord |  |  | TypAkordu (2) | [Kalend/ZestawienieAkorduBase.md](Kalend/ZestawienieAkorduBase.md) |
...
| DokKasowyBase | Dokumenty kasowe | `DokumentyKasowe` |  | root |  | IDokumentKasowy, IDokumentCRM | KierunekPlatnosci (2) | [Kasa/DokKasowyBase.md](Kasa/DokKasowyBase.md) |
| DokRozliczBase | Dokumenty rozliczeniowe | `DokRozliczeniowe` |  | root |  | IDokumentKsiegowalny, IDokumentPlatny, IDokumentCRM, IEmailElement | TypDokumentu (9) | [Kasa/DokRozliczBase.md](Kasa/DokRozliczBase.md) |
| EwidencjaSP | Ewidencje ŚP | `EwidencjeSP` | konfig | root |  | IElementSlownika, IRightsSource | TypEwidencjiSP (3) | [Kasa/EwidencjaSP.md](Kasa/EwidencjaSP.md) |
| FormaPlatnosci | Definicje płatności | `FormyPlatnosci` | konfig | root |  |  |  | [Kasa/FormaPlatnosci.md](Kasa/FormaPlatnosci.md) |
| FormatWymianyElektronicznej | Rachunki bankowe | `FormatyWymElektr` | konfig | root |  |  | TypFormatuWymianyElektronicznej (1) | [Kasa/FormatWymianyElektronicznej.md](Kasa/FormatWymianyElektronicznej.md) |
...
| Platnosc | Płatności | `Platnosci` |  | root |  | IRozliczalny, IElementKsiegowalny, IZrodloOpisuAnalitycznego | KierunekPlatnosci (2) | [Kasa/Platnosc.md](Kasa/Platnosc.md) |
| PozycjaDokRozlicz | Pozycja dokumentu rozliczeniowego | `PozDokRozlicz` |  | child: Dokument→DokRozliczBase |  |  | TypDokumentu (4) | [Kasa/PozycjaDokRozlicz.md](Kasa/PozycjaDokRozlicz.md) |
...
| PrzelewBase | Przelewy | `Przelewy` |  | root |  | IAdresHost | TypPrzelewu (4) | [Kasa/PrzelewBase.md](Kasa/PrzelewBase.md) |
| RachunekBankowyPodmiotu | Rachunki bankowe | `RachBankPodmiot` |  | root |  | IAdresHost | TypRachunkuBankowego (19) | [Kasa/RachunekBankowyPodmiotu.md](Kasa/RachunekBankowyPodmiotu.md) |
...
| Zaplata | Wpłaty i wypłaty | `Zaplaty` |  | root |  | IRozliczalny, IElementKsiegowalny, IZrodloOpisuAnalitycznego, IDaneKontrahentaHost, IDokumentCRM | KierunekPlatnosci (2) | [Kasa/Zaplata.md](Kasa/Zaplata.md) |
...
| DefinicjaAnalityki | Definicje analityk | `DefAnalityk` |  | child: Konto→KontoBase |  |  | TypDefinicjiAnalityki (2) | [Ksiega/DefinicjaAnalityki.md](Ksiega/DefinicjaAnalityki.md) |
...
| DekretBase | Dziennik księgowy | `Dziennik` |  | root |  |  | TypDziennika (2) | [Ksiega/DekretBase.md](Ksiega/DekretBase.md) |
...
| ElemOpisuAnalitycznego | Opis analityczny | `OpisAnalityczny` |  | child: Ewidencja→DokEwidencji |  |  | TypOpisuAnalitycznego (2) | [Ksiega/ElemOpisuAnalitycznego.md](Ksiega/ElemOpisuAnalitycznego.md) |
| ElemSlownika | Elementy słowników | `ElemSlownikow` |  | root |  | IElementSlownika |  | [Ksiega/ElemSlownika.md](Ksiega/ElemSlownika.md) |
| GrupaKont | Grupy kont | `GrupyKont` | konfig | root |  |  | TypGrupyKont (2) | [Ksiega/GrupaKont.md](Ksiega/GrupaKont.md) |
...
| KontoBase | Konto | `Konta` |  | root |  |  | RodzajKonta (3) | [Ksiega/KontoBase.md](Ksiega/KontoBase.md) |
| MatrycaBase | Matryce dokumentów i zapłat | `Matryce` | konfig | root |  |  | TypDokumentu (4) | [Ksiega/MatrycaBase.md](Ksiega/MatrycaBase.md) |
| MatrycaPodmiot | MatrycePodmioty | `MatrycePodmioty` |  |  |  |  |  | [Ksiega/MatrycaPodmiot.md](Ksiega/MatrycaPodmiot.md) |
| ObrotKsiegowyBase | Obrót księgowy | `ObrotyKsiegowe` |  |  |  |  | TypObrotu (2) | [Ksiega/ObrotKsiegowyBase.md](Ksiega/ObrotKsiegowyBase.md) |
| OkresObrachunkowy | Okresy obrachunkowe | `OkresyObrach` | konfig | root |  |  | TypOkresuObrachunkowego (3) | [Ksiega/OkresObrachunkowy.md](Ksiega/OkresObrachunkowy.md) |
...
| PowiazanieKontaBase | Powiązania kont | `PowiazaniaKont` |  | child: Konto→KontoBase |  |  | TypPowiazania (2) | [Ksiega/PowiazanieKontaBase.md](Ksiega/PowiazanieKontaBase.md) |
...
| PozycjaSchematuKsiegowego | Pozycje schematów księgowych | `PozSchemKsiegT` | konfig | child: Schemat→SchematKsiegowy |  |  | TypDokumentu (27) | [Ksiega/PozycjaSchematuKsiegowego.md](Ksiega/PozycjaSchematuKsiegowego.md) |
| PozycjaSprawozdaniaKS | Pozycje sprawozdań księgowych | `PozycjeSprawKS` |  | child: RootPoz→IPozycjaSprawozdaniaRoot |  | IPozycjaSprawozdaniaRoot | TypPozycjiSprawozdzaniaKS (6) | [Ksiega/PozycjaSprawozdaniaKS.md](Ksiega/PozycjaSprawozdaniaKS.md) |
...
| RozliczenieKS | Rozliczenia księgowe | `RozliczeniaKS` |  |  |  | IRozliczenie, IElementKsiegowalny | TypRozliczeniaKS (3) | [Ksiega/RozliczenieKS.md](Ksiega/RozliczenieKS.md) |
| RozliczenieOA | Rozliczenie opisu analitycznego | `RozliczeniaOA` |  |  |  |  |  | [Ksiega/RozliczenieOA.md](Ksiega/RozliczenieOA.md) |
| SchematKsiegowy | Schematy księgowe | `SchematyKsiegowe` | konfig | root |  |  | TypDokumentu (27) | [Ksiega/SchematKsiegowy.md](Ksiega/SchematKsiegowy.md) |
...
| SprawozdanieKS | Sprawozdania księgowe | `SprawozdaniaKS` |  | root |  | IPozycjaSprawozdaniaRoot | RodzajSprawozdaniaKS (12) | [Ksiega/SprawozdanieKS.md](Ksiega/SprawozdanieKS.md) |
| WynikZestKS | Wyniki zestawień księgowych | `WynikiZestKS` |  | root |  |  |  | [Ksiega/WynikZestKS.md](Ksiega/WynikZestKS.md) |
| ZapisKsiegowy | Zapisy księgowe | `ZapisyKsiegowe` |  | child: Dekret→DekretBase |  | IElementKsiegowalny | TypZapisu (2) | [Ksiega/ZapisKsiegowy.md](Ksiega/ZapisKsiegowy.md) |
...
| ZleDlugiDokument | Dokumenty ZD | `ZDDokumenty` |  | root |  | IDokument | TypDokumentu (1) | [Ksiega/ZleDlugiDokument.md](Ksiega/ZleDlugiDokument.md) |
| ZleDlugiPozycja | Pozycje ZD | `ZDPozycje` |  | child: Dokument→ZleDlugiDokument |  |  | TypPozycjiZleDlugi (2) | [Ksiega/ZleDlugiPozycja.md](Ksiega/ZleDlugiPozycja.md) |
...
| ZnacznikKonta | Znaczniki kont | `ZnacznikiKont` | konfig | root |  |  | TypZnacznikaKonta (9) | [Ksiega/ZnacznikKonta.md](Ksiega/ZnacznikKonta.md) |
...
| RowType | Tytuł | Tabela | Konfig | Guided | Historia | Interfaces | Selektor | Plik |
|---------|-------|--------|--------|--------|----------|------------|----------|------|
| ArkuszDefinicjiOceny | Arkusze definicji oceny | `ArkuszeDefOcen` | konfig | child: DefinicjaOceny→DefinicjaOceny |  |  | TypOceny (2) | [Oceny/ArkuszDefinicjiOceny.md](Oceny/ArkuszDefinicjiOceny.md) |
| ArkuszOdpowiedz |  | `ArkuszeOdp` |  |  |  |  |  | [Oceny/ArkuszOdpowiedz.md](Oceny/ArkuszOdpowiedz.md) |
| DefinicjaArkuszaOceny | Definicje arkuszy ocen | `DefArkuszyOcen` | konfig | root |  |  | TypOceny (2) | [Oceny/DefinicjaArkuszaOceny.md](Oceny/DefinicjaArkuszaOceny.md) |
| DefinicjaElementuOceny | Definicje elementów ocen | `DefElementowOcen` | konfig | root |  |  | RodzajeElementuOceny (5) | [Oceny/DefinicjaElementuOceny.md](Oceny/DefinicjaElementuOceny.md) |
| DefinicjaOceny | Definicje ocen | `DefinicjeOcen` | konfig | root |  |  | TypOceny (2) | [Oceny/DefinicjaOceny.md](Oceny/DefinicjaOceny.md) |
...
| KategoriaElementuOceny | Kategorie elementów ocen | `KatElementowOcen` | konfig | root |  |  | TypOceny (2) | [Oceny/KategoriaElementuOceny.md](Oceny/KategoriaElementuOceny.md) |
| OcenaArkusz | Arkusze oceny | `OcenyArkusze` |  | root |  |  | TypOceny (2) | [Oceny/OcenaArkusz.md](Oceny/OcenaArkusz.md) |
...
| OcenaOceniający | Oceniający | `OcenyOceniajacy` |  | child: Ocena→OcenaRealizacja |  |  | TypOceny (2) | [Oceny/OcenaOceniający.md](Oceny/OcenaOceniający.md) |
| OcenaOceniany | Oceniani | `OcenyOceniani` |  | child: Ocena→OcenaRealizacja |  |  | TypOceny (2) | [Oceny/OcenaOceniany.md](Oceny/OcenaOceniany.md) |
| OcenaPowiaz | Powiązanie z ankietą | `OcenyPowiaz` |  | root |  | IOceniany, IŹródłoOceny |  | [Oceny/OcenaPowiaz.md](Oceny/OcenaPowiaz.md) |
| OcenaPozycjaArkusza | Pozycje arkuszy ocen | `OcenyPozArkuszy` |  | root |  |  | TypOceny (2) | [Oceny/OcenaPozycjaArkusza.md](Oceny/OcenaPozycjaArkusza.md) |
| OcenaRealizacja | Oceny | `OcenyRealizacje` |  | root |  | IŹródłoPowiązaniaStrukturyOrganizacyjnej | TypOceny (2) | [Oceny/OcenaRealizacja.md](Oceny/OcenaRealizacja.md) |
| PozycjaDefinicjiArkuszaOceny | Pozycje definicji arkusza oceny | `PozDefArkuszOcen` | konfig | child: DefinicjaArkusza→DefinicjaArkuszaOceny |  |  | TypOceny (2) | [Oceny/PozycjaDefinicjiArkuszaOceny.md](Oceny/PozycjaDefinicjiArkuszaOceny.md) |
| SkalaOcen | Skale ocen | `SkaleOcen` | konfig | root |  |  | RodzajeSkalOcen (3) | [Oceny/SkalaOcen.md](Oceny/SkalaOcen.md) |
...
| RowType | Tytuł | Tabela | Konfig | Guided | Historia | Interfaces | Selektor | Plik |
|---------|-------|--------|--------|--------|----------|------------|----------|------|
| BilansOtwarciaPIT | Bilansy otwarcia PIT | `BilansyOtwPIT` |  | root |  |  | WersjaBilansuOtwarciaPIT (2) | [Place/BilansOtwarciaPIT.md](Place/BilansOtwarciaPIT.md) |
...
| PodstawaNieobecnosci |  | `PodstawyNieobec` |  | child: Pracownik→Pracownik |  |  | TypyPodstawNieobecnosci (2) | [Place/PodstawaNieobecnosci.md](Place/PodstawaNieobecnosci.md) |
...
| WypElement | Elementy wypłaty | `WypElementy` |  | root |  |  | RodzajŹródłaWypłaty (33) | [Place/WypElement.md](Place/WypElement.md) |
| WypSkladnik | Składniki wypłaty | `WypSkladniki` |  | child: Element→WypElement |  |  | RodzajSkładnikaWypłaty (14) | [Place/WypSkladnik.md](Place/WypSkladnik.md) |
| Wyplata | Wypłaty | `Wyplaty` |  | root |  | IDokumentPlatny, IDokumentKsiegowalny, IZrodloOpisuAnalitycznego | TypWyplaty (3) | [Place/Wyplata.md](Place/Wyplata.md) |
...
| RelChangeInfo | Relacje historii zmian | `RelChangeInfos` |  |  |  |  | ChangeInfoRelationType (2) | [PracaHybrydowa/RelChangeInfo.md](PracaHybrydowa/RelChangeInfo.md) |
| ZadaniaRelacja | Relacje Zadań pracy hybrydowej | `ZadRelacje` |  |  |  |  | ZadaniaRelacjaTyp (3) | [PracaHybrydowa/ZadaniaRelacja.md](PracaHybrydowa/ZadaniaRelacja.md) |
...
| ZasobTechn | Zasoby wzorcowe lub rzeczywiste przypisane do obiektów produkcyjnych | `ZasobyTechn` |  |  |  |  | TypZasobuTechn (4) | [Produkcja/ZasobTechn.md](Produkcja/ZasobTechn.md) |
...
| RowType | Tytuł | Tabela | Konfig | Guided | Historia | Interfaces | Selektor | Plik |
|---------|-------|--------|--------|--------|----------|------------|----------|------|
| ElementPrzeszeregowania | Elementy przeszeregowań | `ElementyPrzeszer` |  | child: Przeszeregowanie→Przeszeregowanie |  |  | RodzajPrzeszergowania (6) | [Przeszeregowania/ElementPrzeszeregowania.md](Przeszeregowania/ElementPrzeszeregowania.md) |
...
| ObrotRMK | Obroty RMK | `ObrotyRMK` |  |  |  | IZrodloOpisuAnalitycznego | TypObrotuRMK (2) | [RMK/ObrotRMK.md](RMK/ObrotRMK.md) |
...
| Nieruchomosc | Nieruchomości | `Nieruchomosci` |  | root | historyczna → NieruchomoscHis | IZasobCRM, IDocumentHostCRM, IObiektDoPlanowania | RealEstateKind (10) | [RealEstate/Nieruchomosc.md](RealEstate/Nieruchomosc.md) |
...
| TypNieruchomosc | Typy nieruchomości | `TypyNieruchom` | konfig | root |  | IRightsSource | RealEstateKind (10) | [RealEstate/TypNieruchomosc.md](RealEstate/TypNieruchomosc.md) |
...
| Pojazd |  | `Pojazdy` |  | root |  | IElementSlownika, IZasobCRM | VehicleBusinessType (1) | [Samochodowka/Pojazd.md](Samochodowka/Pojazd.md) |
...
| DokumentST | Dokumenty ŚT | `DokumentyST` |  | root |  | IDokumentKsiegowalny | TypDokumentu (20) | [SrodkiTrwale/DokumentST.md](SrodkiTrwale/DokumentST.md) |
| DokumentUL | Dokumenty UL | `DokumentyUL` |  | root |  | IDokument | TypDokumentu (2) | [SrodkiTrwale/DokumentUL.md](SrodkiTrwale/DokumentUL.md) |
...
| ObrotST | Obroty środków trwałych | `ObrotyST` |  | child: Dokument→DokumentST |  | IZrodloOpisuAnalitycznego | TypObrotuST (17) | [SrodkiTrwale/ObrotST.md](SrodkiTrwale/ObrotST.md) |
...
| RodzajST | Klasyfikacja Rodzajowa Środków Trwałych | `KRST` | konfig | root |  |  | TypSrodkaTrwalego (2) | [SrodkiTrwale/RodzajST.md](SrodkiTrwale/RodzajST.md) |
| SrodekTrwalyBase | Ewidencja środków trwałych oraz wartości niematerialnych i prawnych | `SrodkiTrwale` |  | root | historyczna → SrodekTrwalyBaseHistoria | IInwentarz, IElementSlownika, IZasobCRM, IKodowany, IZrodloPodzielnikaKosztow | TypSrodkaTrwalego (3) | [SrodkiTrwale/SrodekTrwalyBase.md](SrodkiTrwale/SrodekTrwalyBase.md) |
| SrodekTrwalyBaseHistoria | Ewidencja środków trwałych oraz wartości niematerialnych i prawnych - historia | `SrodkiTrwaleHist` |  | child: Srodek→SrodekTrwalyBase | historia → SrodekTrwalyBase |  | TypSrodkaTrwalego (3) | [SrodkiTrwale/SrodekTrwalyBaseHistoria.md](SrodkiTrwale/SrodekTrwalyBaseHistoria.md) |
...
| PrzecenaOkresowa |  | `PrzecenyOkres` |  | root |  |  | CelPrzecenyOkresowej (2) | [Towary/PrzecenaOkresowa.md](Towary/PrzecenaOkresowa.md) |
...
| RowType | Tytuł | Tabela | Konfig | Guided | Historia | Interfaces | Selektor | Plik |
|---------|-------|--------|--------|--------|----------|------------|----------|------|
| DefinicjaSprawyWindykacyjnej | Definicje spraw windykacyjnych | `DefSprawWind` | konfig | root |  | IRightsSource | TypDokumentu (1) | [Windykacja/DefinicjaSprawyWindykacyjnej.md](Windykacja/DefinicjaSprawyWindykacyjnej.md) |
...
| WFDefItem | Wzorce definicji zadań | `WFDefItems` | konfig | root |  | IWFDefItem, IWfPlugInItemReferenceHost | DefinitionTypeEnum (2) | [Workflow/WFDefItem.md](Workflow/WFDefItem.md) |
| WFDefinition | Definicja procesów | `WFDefs` | konfig | root |  | IRightsSource, IWFDefinition, ICodeFileHost, IWfPlugInReferenceHost, ISysNotificationReference, IWizardReferenceHost | DefinitionTypeEnum (2) | [Workflow/WFDefinition.md](Workflow/WFDefinition.md) |
...
| WFProcessRole | Role procesowe | `WFProcessRoles` | konfig | root |  | IWfPlugInItemReferenceHost, IWFRecipientHost | DefinitionTypeEnum (2) | [Workflow/WFProcessRole.md](Workflow/WFProcessRole.md) |
...
| WFTransition | Tranzycje | `WFTransitions` | konfig | root |  | IWFTransition, IWfPlugInItemReferenceHost | DefinitionTypeEnum (2) | [Workflow/WFTransition.md](Workflow/WFTransition.md) |
| WFTransitionDefinition | Wzorce tranzycji | `WFTransitionDefs` | konfig | root |  | IWfPlugInItemReferenceHost | DefinitionTypeEnum (2) | [Workflow/WFTransitionDefinition.md](Workflow/WFTransitionDefinition.md) |
| WFWorkflow | Procesy | `WFWorkflows` |  | root |  | IWFWorkflow, IWFFeatureDefs, IDokument | DefinitionTypeEnum (2) | [Workflow/WFWorkflow.md](Workflow/WFWorkflow.md) |
...
| WfPlugInItem | Wtyczki elementów procesu | `WfPlugInItems` | konfig | root |  | IWfPlugInItemHost | WfPlugInItemType (6) | [Workflow/WfPlugInItem.md](Workflow/WfPlugInItem.md) |
...
| WfTaskSource | Źródła zadań | `WfTaskSources` | konfig | child: TaskDefinition→TaskDefinition |  | IWfPlugInItemReferenceHost | DefinitionTypeEnum (1) | [Workflow/WfTaskSource.md](Workflow/WfTaskSource.md) |
...
| DefBudgetAspect | Perspektywa realizacji | `DefBudgetAspects` | konfig | root |  |  | TypObrotuBudzetu (2) | [Zadania/DefBudgetAspect.md](Zadania/DefBudgetAspect.md) |
| DefBudgetCategory | Kategoria budżetu | `DefBudgetCateg` | konfig | root |  |  | TypObrotuBudzetu (2) | [Zadania/DefBudgetCategory.md](Zadania/DefBudgetCategory.md) |
...
| DefPlanVersion | Definicje planów wersji | `DefPlanVersions` | konfig | root |  |  | PlanVersionType (2) | [Zadania/DefPlanVersion.md](Zadania/DefPlanVersion.md) |
...
| PlanVariant | Warianty planów | `PlanVariants` | konfig | child: DefBudget→DefBudget |  |  | PlanVariantKind (2) | [Zadania/PlanVariant.md](Zadania/PlanVariant.md) |
...
| WersjaPlanu | Wersje planu dla budżetu projektu | `WersjePlanu` |  | root |  | IDokument | PlanVersionManagement (2) | [Zadania/WersjaPlanu.md](Zadania/WersjaPlanu.md) |
...
| Zadanie | Zadania i zdarzenia CRM | `Zadania` |  | root |  | ITimeTrack, IElementSlownika, IEmailElement, IDocumentHostCRM, IManagedRowInfoHost, IToDoItemHost | RodzajZadania (14) | [Zadania/Zadanie.md](Zadania/Zadanie.md) |
