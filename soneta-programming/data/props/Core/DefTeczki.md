# Pola i właściwości klasy biznesowej: `Soneta.Core.DefTeczki`
Nazwa tabeli: `DefsTeczek`
Tytuł: Definicje teczek
Opis: Definicja typu teczki (sprawy, akt). Określa symbol, nazwę, sposób numeracji, dostępność, blokadę oraz opcjonalny formularz użytkownika. Teczki służą do grupowania powiązanych dokumentów i obiektów.
...
### DostepnoscTeczki (`Soneta.Core.DostepnoscTeczki`)
- `Prywatna` = 1 — Prywatna
- `Publiczna` = 2
