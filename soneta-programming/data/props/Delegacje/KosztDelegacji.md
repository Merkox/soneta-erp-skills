...
|------|-----|--------|-------|------|
| Data | `Soneta.Types.Date` | bazodanowe |  | Data poniesienia kosztu |
...
| Etap | `Soneta.Delegacje.EtapDelegacji` | bazodanowe |  | Etap delegacji, do którego należy koszty |
| Korekta | `bool` | bazodanowe |  | Czy dane mają być traktowane jako korekta - czyli z odwrotnym znakiem |
| Koszt | `Soneta.Types.Currency` | bazodanowe |  | Wartość kosztu do rozliczenia w delegacji |
| Lp | `int` | bazodanowe |  |  |
| NumerDokumentuKSeF | `string` | bazodanowe |  | Numer dokumentu nadany przez KSeF |
| Opis | `string` | bazodanowe |  | Opis poniesionego kosztu |
| Rodzaj | `Soneta.Delegacje.RodzajKosztuDelegacji` | bazodanowe, enum |  | Klasyfikacja kosztu delegacji |
