# Pola i właściwości klasy biznesowej: `Soneta.Kasa.DokRozliczBase`
Nazwa tabeli: `DokRozliczeniowe`
Tytuł: Dokumenty rozliczeniowe
Opis: Dokument rozliczeniowy (nota odsetkowa, kompensata, wezwanie do zapłaty itp.) generowany w procesie rozrachunków z kontrahentami. Obsługuje wielowalutowość, posiada pozycje szczegółowe z rozliczeniami i może zawierać płatności powiązane z dokumentem.
