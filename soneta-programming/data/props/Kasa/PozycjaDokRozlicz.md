# Pola i właściwości klasy biznesowej: `Soneta.Kasa.PozycjaDokRozlicz`
Nazwa tabeli: `PozDokRozlicz`
Tytuł: Pozycja dokumentu rozliczeniowego
...
|------|-----------|------------------------|
| DokRozliczany | `IRozliczalny` | `Platnosc`, `Zaplata` |
| Platnosc | `IRozliczalny` | `Platnosc`, `Zaplata` |
