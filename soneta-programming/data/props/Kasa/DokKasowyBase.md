# Pola i właściwości klasy biznesowej: `Soneta.Kasa.DokKasowyBase`
Nazwa tabeli: `DokumentyKasowe`
Tytuł: Dokumenty kasowe
Opis: Dokument kasowy (KP/KW) rejestrujący operację wpłaty lub wypłaty gotówkowej w kasie. Powiązany z ewidencją środków pieniężnych i raportem kasowym, stanowi podstawę do tworzenia zapisów kasowych (zapłat) w systemie.
