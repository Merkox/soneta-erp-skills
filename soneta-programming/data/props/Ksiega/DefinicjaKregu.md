# Pola i właściwości klasy biznesowej: `Soneta.Ksiega.DefinicjaKregu`
Nazwa tabeli: `DefinicjeKregow`
Tytuł: Definicje kręgów
Opis: Definicja kręgu kosztów służy do kontroli zamknięcia kręgu księgowań. Określa zbiór kont, których salda powinny się bilansować w ramach danego typu dokumentu, umożliwiając wykrywanie niekompletnych lub błędnych dekretacji.
